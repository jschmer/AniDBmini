...
{
    public class MylistTreeEntry
    {

        #region Properties

        private List<MylistTreeEntry> children = new List<MylistTreeEntry>();
        public List<MylistTreeEntry> Children { get { return children; } }
        ...
        public static MylistTreeEntry FromAnime(AnimeEntry entry)
        {
            MylistTreeEntry m_entry = new MylistTreeEntry();
        ...
        public static MylistTreeEntry FromEpisode(EpisodeEntry entry)
        {
            MylistTreeEntry m_entry = new MylistTreeEntry();
            TimeSpan length = TimeSpan.FromSeconds(entry.length);
        ...
        public static MylistTreeEntry FromFile(FileEntry entry)
        {
            MylistTreeEntry m_entry = new MylistTreeEntry();
            TimeSpan length = TimeSpan.FromSeconds(entry.length);
